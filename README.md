...
- **Batch Analysis**: Upload a CSV file (must have a 'review' column) to analyze multiple texts at once.
- **Visualization**: Bar chart showing the count of each sentiment in batch results.
